...
(cl:defmethod cl:initialize-instance :after ((m <cellulo_visual_effect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cellulo_visual_effect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_cellulo-msg:<cellulo_visual_effect> is deprecated: use ros_cellulo-msg:cellulo_visual_effect instead.")))

(cl:ensure-generic-function 'effect-val :lambda-list '(m))
(cl:defmethod effect-val ((m <cellulo_visual_effect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-msg:effect-val is deprecated.  Use ros_cellulo-msg:effect instead.")
  (effect m))

(cl:ensure-generic-function 'red-val :lambda-list '(m))
(cl:defmethod red-val ((m <cellulo_visual_effect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-msg:red-val is deprecated.  Use ros_cellulo-msg:red instead.")
  (red m))

(cl:ensure-generic-function 'green-val :lambda-list '(m))
(cl:defmethod green-val ((m <cellulo_visual_effect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-msg:green-val is deprecated.  Use ros_cellulo-msg:green instead.")
  (green m))

(cl:ensure-generic-function 'blue-val :lambda-list '(m))
(cl:defmethod blue-val ((m <cellulo_visual_effect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-msg:blue-val is deprecated.  Use ros_cellulo-msg:blue instead.")
  (blue m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <cellulo_visual_effect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-msg:value-val is deprecated.  Use ros_cellulo-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cellulo_visual_effect>)))
  ...
  "ros_cellulo/cellulo_visual_effect")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cellulo_visual_effect)))
  "Returns string type for a message object of type 'cellulo_visual_effect"
  "ros_cellulo/cellulo_visual_effect")
