...
(cl:defmethod cl:initialize-instance :after ((m <cellulo_coord>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cellulo_coord)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_cellulo-msg:<cellulo_coord> is deprecated: use ros_cellulo-msg:cellulo_coord instead.")))
