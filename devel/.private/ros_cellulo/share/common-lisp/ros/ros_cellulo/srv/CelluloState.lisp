...
(cl:defmethod cl:initialize-instance :after ((m <CelluloState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CelluloState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_cellulo-srv:<CelluloState-request> is deprecated: use ros_cellulo-srv:CelluloState-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CelluloState-request>)))
  ...
  "ros_cellulo/CelluloStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CelluloState-request)))
  "Returns string type for a service object of type 'CelluloState-request"
  "ros_cellulo/CelluloStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CelluloState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CelluloState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_cellulo-srv:<CelluloState-response> is deprecated: use ros_cellulo-srv:CelluloState-response instead.")))

(cl:ensure-generic-function 'Position-val :lambda-list '(m))
(cl:defmethod Position-val ((m <CelluloState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-srv:Position-val is deprecated.  Use ros_cellulo-srv:Position instead.")
  (Position m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <CelluloState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-srv:vy-val is deprecated.  Use ros_cellulo-srv:vy instead.")
  (vy m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <CelluloState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-srv:vx-val is deprecated.  Use ros_cellulo-srv:vx instead.")
  (vx m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <CelluloState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-srv:w-val is deprecated.  Use ros_cellulo-srv:w instead.")
  (w m))

(cl:ensure-generic-function 'kidnapped-val :lambda-list '(m))
(cl:defmethod kidnapped-val ((m <CelluloState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-srv:kidnapped-val is deprecated.  Use ros_cellulo-srv:kidnapped instead.")
  (kidnapped m))

(cl:ensure-generic-function 'keysTouched-val :lambda-list '(m))
(cl:defmethod keysTouched-val ((m <CelluloState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-srv:keysTouched-val is deprecated.  Use ros_cellulo-srv:keysTouched instead.")
  (keysTouched m))

(cl:ensure-generic-function 'keysLongTouched-val :lambda-list '(m))
(cl:defmethod keysLongTouched-val ((m <CelluloState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo-srv:keysLongTouched-val is deprecated.  Use ros_cellulo-srv:keysLongTouched instead.")
  (keysLongTouched m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CelluloState-response>)))
  ...
  "ros_cellulo/CelluloStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CelluloState-response)))
  "Returns string type for a service object of type 'CelluloState-response"
  "ros_cellulo/CelluloStateResponse")
