...
(cl:defmethod cl:initialize-instance :after ((m <cellulo_vibrateOnMotion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cellulo_vibrateOnMotion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_cellulo_swarm-msg:<cellulo_vibrateOnMotion> is deprecated: use ros_cellulo_swarm-msg:cellulo_vibrateOnMotion instead.")))

(cl:ensure-generic-function 'iCoeff-val :lambda-list '(m))
(cl:defmethod iCoeff-val ((m <cellulo_vibrateOnMotion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo_swarm-msg:iCoeff-val is deprecated.  Use ros_cellulo_swarm-msg:iCoeff instead.")
  (iCoeff m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cellulo_vibrateOnMotion>)))
  ...
  "ros_cellulo_swarm/cellulo_vibrateOnMotion")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cellulo_vibrateOnMotion)))
  "Returns string type for a message object of type 'cellulo_vibrateOnMotion"
  "ros_cellulo_swarm/cellulo_vibrateOnMotion")
