...
(cl:defmethod cl:initialize-instance :after ((m <cellulo_pose_velocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cellulo_pose_velocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_cellulo_swarm-msg:<cellulo_pose_velocity> is deprecated: use ros_cellulo_swarm-msg:cellulo_pose_velocity instead.")))

(cl:ensure-generic-function 'Position-val :lambda-list '(m))
(cl:defmethod Position-val ((m <cellulo_pose_velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo_swarm-msg:Position-val is deprecated.  Use ros_cellulo_swarm-msg:Position instead.")
  (Position m))
...
(cl:defmethod xEnabled-val ((m <cellulo_pose_velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo_swarm-msg:xEnabled-val is deprecated.  Use ros_cellulo_swarm-msg:xEnabled instead.")
  (xEnabled m))

(cl:ensure-generic-function 'yEnabled-val :lambda-list '(m))
(cl:defmethod yEnabled-val ((m <cellulo_pose_velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo_swarm-msg:yEnabled-val is deprecated.  Use ros_cellulo_swarm-msg:yEnabled instead.")
  (yEnabled m))

(cl:ensure-generic-function 'thetaEnabled-val :lambda-list '(m))
(cl:defmethod thetaEnabled-val ((m <cellulo_pose_velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cellulo_swarm-msg:thetaEnabled-val is deprecated.  Use ros_cellulo_swarm-msg:thetaEnabled instead.")
  (thetaEnabled m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cellulo_pose_velocity>)))
  ...
  "ros_cellulo_swarm/cellulo_pose_velocity")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cellulo_pose_velocity)))
  "Returns string type for a message object of type 'cellulo_pose_velocity"
  "ros_cellulo_swarm/cellulo_pose_velocity")
